...
public class Topics extends Fragment {
    ...
    Button flames, compound, mainMenu;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        flames = view.findViewById(R.id.flames);
        compound = view.findViewById(R.id.compoundButton);
        mainMenu = view.findViewById(R.id.scoreMenu);
        ...
        flames.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_topics_to_flames);
            }
        });
        ...
        compound.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_topics_to_compounds);
            }
        });
        ...
        mainMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_topics_to_start3);
            }
        });
    }
}
